...
const UI_TEXT: Record<string, { title: string; subtitle: string; inputLabel: string; placeholder: string; submit: string; footer: string; home: string; todayMission: string; solution: string; export: string; achievements: string; backHome: string; logout: string }> = {
  'zh-TW': { title: '任務挑戰', subtitle: '有些困難不是不能解，現在寫下來吧', inputLabel: '自信感', placeholder: '寫下你的想法或解決方法...', submit: '送出', footer: '書吏', home: '首頁', todayMission: '今日任務', solution: '解決方案', export: '匯出', achievements: '成就', backHome: '返回首頁', logout: '登出' },
  'zh-CN': { title: '任务挑战', subtitle: '有些困难不是不能解决，现在写下来吧', inputLabel: '自信感', placeholder: '写下你的想法或解决方法...', submit: '提交', footer: '书吏', home: '首页', todayMission: '今日任务', solution: '解决方案', export: '导出', achievements: '成就', backHome: '返回首页', logout: '登出' },
  'en': { title: 'Mission Challenge', subtitle: 'Some difficulties are not unsolvable, write them down now.', inputLabel: 'Confidence', placeholder: 'Write your thoughts or solution...', submit: 'Submit', footer: 'Scribe', home: 'Home', todayMission: "Today's Mission:", solution: 'Solution:', export: 'Export', achievements: 'Achievements:', backHome: 'Back to Home', logout: 'Logout' },
  'ja': { title: 'ミッション挑戦', subtitle: '解決できない困難はありません。今すぐ書き出しましょう。', inputLabel: '自信', placeholder: 'あなたの考えや解決策を書いてください...', submit: '送信', footer: '書記', home: 'ホームへ戻る', todayMission: '今日のミッション', solution: '解決策', export: 'エクスポート', achievements: '実績', backHome: 'ホームへ戻る', logout: 'ログアウト' },
  'ko': { title: '미션 도전', subtitle: '어려움은 해결할 수 있습니다. 지금 적어보세요.', inputLabel: '자신감', placeholder: '생각이나 해결책을 적어보세요...', submit: '제출', footer: '서기', home: '홈으로', todayMission: '오늘의 미션:', solution: '해결책:', export: '내보내기', achievements: '업적:', backHome: '홈으로', logout: '로그아웃' },
  'vi': { title: 'Thử thách nhiệm vụ', subtitle: 'Một số khó khăn không phải là không thể giải quyết, hãy viết ra ngay bây giờ.', inputLabel: 'Tự tin', placeholder: 'Viết suy nghĩ hoặc giải pháp của bạn...', submit: 'Gửi', footer: 'Thư ký', home: 'Trang chủ', todayMission: 'Nhiệm vụ hôm nay:', solution: 'Giải pháp:', export: 'Xuất', achievements: 'Thành tích:', backHome: 'Trang chủ', logout: 'Đăng xuất' },
};
